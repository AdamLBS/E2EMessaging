...
class OneTimePrekeys
{
  public:
     ...
     */
    explicit OneTimePrekeys(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit OneTimePrekeys(const Json::Value &pJson) noexcept(false);
     ...
     */
    OneTimePrekeys(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    OneTimePrekeys() = default;
  ...
  private:
    friend drogon::orm::Mapper<OneTimePrekeys>;
    friend drogon::orm::BaseBuilder<OneTimePrekeys, true, true>;
    friend drogon::orm::BaseBuilder<OneTimePrekeys, true, false>;
    friend drogon::orm::BaseBuilder<OneTimePrekeys, false, true>;
    friend drogon::orm::BaseBuilder<OneTimePrekeys, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<OneTimePrekeys>;
#endif
