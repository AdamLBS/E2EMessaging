...
class Messages
{
  public:
    struct Cols
    {
        ...
        static const std::string _from_user;
        static const std::string _to_user;
        static const std::string _ciphertext;
    ...
    ///Get the value of the column ciphertext, returns the default value if the column is null
    const std::string &getValueOfCiphertext() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getCiphertext() const noexcept;
    ///Set the value of the column ciphertext
    void setCiphertext(const std::string &pCiphertext) noexcept;
    void setCiphertext(std::string &&pCiphertext) noexcept;
