...
class SignedPrekeys
{
  public:
     ...
     */
    explicit SignedPrekeys(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit SignedPrekeys(const Json::Value &pJson) noexcept(false);
     ...
     */
    SignedPrekeys(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    SignedPrekeys() = default;
  ...
  private:
    friend drogon::orm::Mapper<SignedPrekeys>;
    friend drogon::orm::BaseBuilder<SignedPrekeys, true, true>;
    friend drogon::orm::BaseBuilder<SignedPrekeys, true, false>;
    friend drogon::orm::BaseBuilder<SignedPrekeys, false, true>;
    friend drogon::orm::BaseBuilder<SignedPrekeys, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<SignedPrekeys>;
#endif
